...
class LogbooksAddController extends AbstractActionController
{
    public function logbooksAddAction()
    {
    	$detail = '';
    	$generated_id = 0;
    	try {
    	    ...
    	    $data['time'] = time();
    	    $generated_id = $data['id'] = $this->get('LogBookTable')->save($data);
    	    ...
    	    $detail = $this->translate("Logbook added!");
    	} catch (\Exception $e) {
