...
class ProfileExperienceEditController extends AbstractActionController
{
    public function profileExperienceEditAction()
    {
    	$detail = '';
    	$affected_id = 0;
    	try {
    	    ...
    	    $affected_id = $data['id'];
    	    $detail = $this->translate("Experience saved!");
    	} catch (\Exception $e) {
